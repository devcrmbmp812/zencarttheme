	...
	public function parseRequest()
	{
		...
		if(!empty($method))
		{
			switch ($method)
			{
				...
				echo $str =$this->$method($username,$password,$start_item_no,$limit,$UpdatedDate,$datefrom,$storeid,$others);
				...
				case 'getOrders_button':
				$method ='getOrders_button';	
				echo $str = $this->$method($id);
				break;
