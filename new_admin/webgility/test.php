...
$urltopost = str_replace('test.php','zencart.php',$urltopost);
...
if (isset($_POST["btncheck"]) && ($_POST["btncheck"]=="Test" || $_POST["btncheck"]=="Mail To Webgility")) {
	if (trim($_POST["uname"])!="" && trim($_POST["pwd"])!="") {
		...
		if(isset($_POST['sendmail']) && $_POST['sendmail']=='Y') {
			$subject="Webgility test Information(Zencart)";
...
<body style="font-size:13px;">
		...
		<div id="content" align="center">
			...
			<div id="information"> <h2><strong>Required Extensions:</strong></h2></div>
                                        ...
                                        <?php if(substr(decoct(fileperms(getcwd())),2) == '777'){?>
										<div class="green_tr">Required Permission On Webglity Folder<?php echo phpversion();?> &nbsp;:&nbsp; <span style=" color:#006600"> Ok </span> </div>
										<?php }else{?>
										<div class="green_tr">Required Permission On Webgility Folder<?php echo phpversion();?> &nbsp;:&nbsp; 777 Neede </div>
										<?php } ?>
