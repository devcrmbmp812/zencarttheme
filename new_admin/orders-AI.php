...
?>
      ...
      <tr>
        <?php
        function help_popup_anchor($id, $title='View Packaging Details', $class='', $width=420, $height=600) {
               $element = "View Packaging Details";

               $x = " - <A HREF=\"javascript:void(0)\" onClick=\"return window.open('order_package_details.php?id=".$id."', 'package_detail', 'width=".$width.", height=".$height."');\" " .
                    'TITLE="' . ( strlen($title) > 0 ? $title : "Help") . '" ' .
        ...
        ?>       
        <td class="main"><strong><?php echo ENTRY_ORDER_ID . $oID . (MODULE_SHIPPING_AUCTIONINC_STATUS=='On' ? help_popup_anchor($oID) : ''); ?></strong></td>
      </tr>
      <tr>
