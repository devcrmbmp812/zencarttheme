...
ob_start();
?>
Hosted by &lt;<a href="http://www.ixwebhosting.com/">ixwebhosting.com</a>&gt;
<?php
$str_brand_powered_by = ob_get_clean();

  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a> &ndash; '.$str_brand_powered_by);
