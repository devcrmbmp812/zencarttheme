...
define('MODULE_SHIPPING_FREEOPTIONS_TEXT_TITLE', 'Shipping Invoice');
...
See: freeshipper
');
define('MODULE_SHIPPING_FREEOPTIONS_TEXT_WAY', 'Shipping costs will be calculated and an invoice emailed once order has been completed');
