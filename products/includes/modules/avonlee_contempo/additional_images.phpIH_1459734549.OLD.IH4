...
if ($num_images) {
  ...
  for ($i=0, $n=$num_images; $i<$n; $i++) {
    $file = $images_array[$i];
 //Uncomment next line and comment one after to return to regular functioning.
 //   $products_image_large = str_replace(DIR_WS_IMAGES, DIR_WS_IMAGES . 'large/', $products_image_directory) . str_replace($products_image_extension, '', $file) . IMAGE_SUFFIX_LARGE . $products_image_extension;
   $products_image_large = str_replace(DIR_WS_IMAGES, DIR_WS_IMAGES . '', $products_image_directory) . str_replace($products_image_extension, '', $file) . $products_image_extension; 
