 ...
 *
 * $Id: ShipRateParserXMLItem.inc,v 1.7 2010/09/28 00:58:01 dsherman Exp $
 *
...
class ShipRateParserXMLItem extends ShipRateParserXML
{
   ...
   function startHandler($xp, $name, $attribs)
   {
      ...
      if ( $name == "ShipRate" && is_array($this->dom['ShipRate'][$this->_rate_cnt]["PackageDetail"][$this->_pkg_cnt])){
