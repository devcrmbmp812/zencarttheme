...
// page title
define('TITLE', 'Boscoyo Studio');

// Site Tagline
define('SITE_TAGLINE', 'Custom Promotional Products');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'boscoyo studio, christmas, custom promotional products, custom engraving');
