...
define('TEXT_SHIPPING_INFO','Most items are manufactured here. Takes time to process orders depending on the amount of stock.  After Processing, orders will then be shipped according to shipping selected.  Some occasions there could be times shipping provider may be changed if needed because of cost of shipping not matching shipping paid.  We will however keep it to the same timeframe as shipping selected or better.  Products are combined the best way for shipping so some orders could have more than one box. Shipping times are only for once the item is shipped and that is with the shipping provider.  Please note USPS priority mail is not guaranteed. \n 
...
Returns:
Please email customer service for returns.');
