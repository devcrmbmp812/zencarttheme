...
Define('HOME', '<li><a href="http://www.boscoyostudio.com/index.php">' . HEADER_TITLE_CATALOG . '</a></li>');
...
Define('ABOUT', '<li><a href="http://www.boscoyostudio.com/index.php?main_page=page_3">' . BOX_INFORMATION_ABOUT_US . '</a></li>');
...
Define('FACEBOOK', '<li><a href="https://www.facebook.com/BoscoyoStudio/" target="_blank">Facebook</a></li>');
Define('GALLERY', '<li><a href="index.php?main_page=page_2">Gallery</a></li>'); 
