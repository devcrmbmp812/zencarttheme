...
if ($num_products_count > 0) {
  ...
  while (!$specials_index->EOF) {
	...
	$products_name = '<a class="product-name name" href="' . zen_href_link(zen_get_info_page($specials_index->fields['products_id']), 'cPath=' . $productsInCategory[$specials_index->fields['products_id']] . '&products_id=' . $specials_index->fields['products_id']) . '">' . substr(strip_tags($specials_index->fields['products_name']), 0, 25) . '</a>';
    
	$products_desc = substr(strip_tags($specials_index->fields['products_description']), 0, 109) . '...';
    ...
    'text' => 
			...
			'<div class="product-col" data-match-height="specials">
				<div class="img">
					' . $products_img . '
				</div>
				<div class="prod-info">
