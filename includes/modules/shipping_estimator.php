...
*/
  ...
  if ($_SESSION['customer_id']) {
	...
	if (MODULE_SHIPPING_AUCTIONINC_STATUS=='On') $order->products=$_SESSION['cart']->get_products();						 
  }
...
// set cheapest last
  if (MODULE_SHIPPING_AUCTIONINC_STATUS !='On') $selected_shipping = $shipping_modules->cheapest();
