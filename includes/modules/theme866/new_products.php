...
if ($num_products_count > 0) {
  ...
  while (!$new_products->EOF) {
	...
	$products_name = '<a class="product-name name" href="' . zen_href_link(zen_get_info_page($new_products->fields['products_id']), 'cPath=' . $productsInCategory[$new_products->fields['products_id']] . '&products_id=' . $new_products->fields['products_id']) . '">' . substr(strip_tags($new_products->fields['products_name']), 0, 25) . '</a>';
    
	$products_desc = substr(strip_tags($new_products->fields['products_description']), 0, 40) . '...';
    ...
    'text' => 
			...
			'<div data-match-height="items-g" class="product-col">
				<div class="img">
					' . $products_img . '
				</div>
				<div class="prod-info">
