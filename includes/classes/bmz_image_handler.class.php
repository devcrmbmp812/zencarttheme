    ...
    if ($this->sizetype == 'small') {
      if ($ihConf[$this->sizetype]['zoom']) {
       ...
       // strip potential suffixes just to be sure
        ...
        return $parameters . 'style="position:relative" onmouseover="showtrail(' . "'$products_image_zoom','$alt',$width,$height,$zoomwidth,$zoomheight,this," . $this->zoom['startx'].','.$this->zoom['starty'].');" onmouseout="hidetrail();" ';
      }
       return $parameters;
    }
    return $parameters;
