...
//echo 'Product Attribute before: ' . $new_attributes_price_before_discounts . '<br>';
  ...
  function get_products($check_for_valid_cart = false) {
    ...
    reset($this->contents);
    while (list($products_id, ) = each($this->contents)) {
      // Select the actioninc shipping module specifc values if the module enabled
      if (MODULE_SHIPPING_AUCTIONINC_STATUS=='On') {
               $products_query = "select p.products_id, p.master_categories_id, p.products_status, 
                                ...
                                p.actioninc_calcmethod,p.actioninc_length,p.actioninc_width,                                    
                                p.actioninc_height,p.actioninc_package,p.actioninc_origincode,                                    
                                p.actioninc_insurable,p.actioninc_handlingcode,p.actioninc_fixeddollaramount,                   
...
//@@TODO - should be okay to remove
        ...
        // Store the ActionInc Specific Values into an array if the module is enabled 
        if (MODULE_SHIPPING_AUCTIONINC_STATUS=='On') {
           $idx = count($products_array)-1;
         
           $products_array[$idx]['actioninc_calcmethod'] = $products->fields['actioninc_calcmethod'];
           $products_array[$idx]['actioninc_length'] =  $products->fields['actioninc_length'];
           $products_array[$idx]['actioninc_width'] =  $products->fields['actioninc_width'];
           $products_array[$idx]['actioninc_height'] =  $products->fields['actioninc_height'];
           $products_array[$idx]['actioninc_package'] =  $products->fields['actioninc_package'];
           $products_array[$idx]['actioninc_origincode'] =  $products->fields['actioninc_origincode'];
           $products_array[$idx]['actioninc_insurable'] =  $products->fields['actioninc_insurable'];
           $products_array[$idx]['actioninc_handlingcode'] =  $products->fields['actioninc_handlingcode'];
           $products_array[$idx]['actioninc_fixeddollaramount'] =  $products->fields['actioninc_fixeddollaramount'];
           $products_array[$idx]['actioninc_servicecodes'] =  $products->fields['actioninc_servicecodes'];
           $products_array[$idx]['actioninc_specialaccessorialfees'] =  $products->fields['actioninc_specialaccessorialfees'];
           $products_array[$idx]['actioninc_fixedfeecode'] =  $products->fields['actioninc_fixedfeecode'];
           $products_array[$idx]['actioninc_fixedfee1'] =  $products->fields['actioninc_fixedfee1'];
           $products_array[$idx]['actioninc_fixedfee2'] =  $products->fields['actioninc_fixedfee2'];
        }  
      }
    }
