  ...
  if ($products_new_split->number_of_rows > 0) {
    ...
    while (!$products_new->EOF) { 
      ...
      if (PRODUCT_NEW_LIST_DESCRIPTION > '0') {
        ...
        $display_products_description = substr(strip_tags($disp_text, PRODUCT_NEW_LIST_DESCRIPTION), 0, 70) . '...';
      } else {
        $display_products_description = '';
      }
	  
	  
		$the_button3 = '<div class="button"><a class="btn add-to-cart" href="' . zen_href_link(FILENAME_PRODUCTS_NEW, zen_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $products_new->fields["products_id"]) . '">' . zen_image_button(BUTTON_IMAGE_ADD_TO_CART, BUTTON_IN_CART_ALT) . '</a></div>';
